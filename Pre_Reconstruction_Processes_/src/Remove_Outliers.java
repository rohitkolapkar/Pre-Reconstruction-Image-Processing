...
public class Remove_Outliers implements PlugIn, DialogListener {
	...
	private void createGui() {
		...
		GenericDialog gd = new GenericDialog("Pre Reconstruction Processes:Remove Outliers");
	    ...
	    Checkbox checkBox1 = new Checkbox("Remove Outliers", noise, true);    
	...
	public boolean dialogItemChanged(GenericDialog gd, AWTEvent e) {
		   ...
		   // Exit if cancel is pressed
			...
			if (gd.wasOKed()){
				...
				IJ.log("1.Remove Outliers is enabled");
				//execute
				removeOutliers();
				return true;
	    	}
	...
	private void removeOutliers() {
		...
		IJ.log("Remove Outliers Result saved at "+noise_destination_dirpath);
		}
